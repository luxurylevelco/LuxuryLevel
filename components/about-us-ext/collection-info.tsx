...
export default function CollectionInfo() {
  return (
    <div className='flex flex-col bg-background h-fit w-full px-10 2xl:px-40 py-10 gap-8'>
      ...
      <div className='flex flex-col gap-3'>
        ...
        <div className='flex flex-col md:flex-row gap-3'>
          <div className='flex flex-col w-full md:w-1/2 border-2 border-gray-300 p-5 gap-5 text-center'>
