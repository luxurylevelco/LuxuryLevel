...
export default function LimitedEdition() {
  return (
    <div className='padding min-h-screen bg-white flex flex-col'>
      <div className='flex flex-col-reverse md:flex-row w-full h-fit 2xl:px-20 gap-10'>
        {/* Left side (Image) */}
        ...
        <div className='flex flex-col justify-center items-center md:w-1/2 gap-6'>
          ...
          <div className='flex flex-col gap-5 text-center md:text-start lg:text-center'>
            <p>
