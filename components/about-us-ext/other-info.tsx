export default function OtherInfo() {
  return (
    <div className='flex flex-col bg-white h-fit w-full px-10 2xl:px-40 py-10 gap-8'>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Presence on Well-Known E-Commerce:</p>
        <p>
          Our presence on well-known e-commerce websites like James Edition and
          Chrono24 has strengthened our reputation as a reliable luxury
          retailer. With over 1000 successful transactions and positive reviews,
          we have extended the trust we earned at our physical boutique to the
          online world.
        </p>
      </div>
      <div className='flex flex-col gap-3'>
        ...
        <p>
          ...
          promotions to offer a transparent and engaging shopping experience,
