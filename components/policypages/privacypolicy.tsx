  ...
  return (
    <div className='h-fit w-full bg-white px-10 md:px-20 lg:px-60 pt-10 pb-20 flex flex-col justify-center items-start gap-12'>
      <p>
        ...
        luxurylevel.com website (“Website” or “Service”) and any of its related
        products and services (collectively, “Services”) is collected,
        protected, and used. <br />
        <br /> It also describes the choices available to you regarding our use
        ...
        (“User,” “you” or “your”) and Luxury Level Watches Trading, the owner
        and operator of the luxurylevel.com website (“Operator,” “we,” “us,” or
        “our”). <br /> <br /> By accessing and using the Website and Services,
        you acknowledge that you have read, understood, and agree to be bound by
        the terms of this Agreement. This Policy does not apply to the practices
      ...
      <div className='flex flex-col gap-3'>
        ...
        <p>
          ...
          Services. <br /> <br /> Information collected automatically is used
          only to identify potential cases of abuse and establish statistical
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Collection of Personal Information</p>
        <p>
          ...
          address). <br /> <br /> We receive and store any information you
          knowingly provide to us when you create an account, or fill any online
          forms on the Website. When required, this information may include the
          following: <br /> <br /> • Personal details such as name, country of
          residence, etc. <br /> • Contact information such as email address,
          address, etc. <br /> • Account details such as user name, unique user
          ID, password, etc. <br /> <br /> Some of the information we collect is
          directly from you via the Website and Services. However, we may also
          collect Personal Information about you from other sources such as
          public databases and our joint marketing partners. <br /> <br />
      ...
      <div className='flex flex-col gap-3'>
        ...
        <p>
          ...
          the following purposes: <br /> <br /> • Create and manage user
          accounts
          <br /> • Respond to inquiries and offer support <br /> • Improve user
          experience
          <br /> • Respond to legal requests and prevent harm <br /> • Run and
          operate the Website and Services <br /> <br /> Processing your
          Personal Information depends on how you interact with the Website and
          Services, where you are located in the world and if one of the
          following applies: <br /> <br /> (I) you have given your consent for
          one or more specific purposes; this, however, does not apply, whenever
          the processing of Personal Information is subject to European data
          protection law <br /> <br /> (II) provision of information is
          necessary for the performance of an agreement with you and/or for any
          pre-contractual obligations thereof <br /> <br /> (III) processing is
          necessary for compliance with a legal obligation to which you are
          subject <br /> <br /> (IV) processing is related to a task that is
          carried out in the public interest or in the exercise of official
          authority vested in us <br /> <br /> (V) processing is necessary for
          the purposes of the legitimate interests pursued by us or by a third
          party. <br /> <br /> Note that under some legislations we may be
          ...
          following legal bases below. <br /> <br /> In any case, we will be
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Managing Payment Processing Data</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Managing Information</p>
        <p>
          ...
          Services change. <br /> <br /> When you delete Personal Information,
          ...
          described below. <br /> <br /> If you would like to delete your
          Personal Information or permanently delete your account, you can do so
          on the settings page of your account on the Website or simply by
          contacting us.
        </p>
      </div>
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Disclosure of Information</p>
        <p>
          ...
          <br /> <br /> These service providers are not authorized to use or
          disclose your information except as necessary to perform services on
          our behalf or comply with legal requirements. We may share your
          Personal Information for these purposes only with third parties whose
          privacy policies are consistent with ours or who agree to abide by our
          policies with respect to Personal Information. <br /> <br /> These
          third parties are given Personal Information they need only in order
          to perform their designated functions, and we do not authorize them to
          use or disclose Personal Information for their own marketing or other
          purposes. <br /> <br /> We will disclose any Personal Information we
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Retention of Information</p>
        <p>
          ...
          permitted by law. <br /> <br /> We may use any aggregated data derived
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>The Rights of Users</p>
        <p>
          You may exercise certain rights regarding your information processed
          by us. In particular, you have the right to do the following: <br />{' '}
          <br /> (I) you have the right to withdraw consent where you have
          previously given your consent to the processing of your information.
          <br /> <br />
          ...
          than consent. <br /> <br /> (III) you have the right to learn if
          ...
          undergoing processing. <br /> <br /> (IV) you have the right to verify
          the accuracy of your information and ask for it to be updated or
          corrected. <br /> <br /> (V) you have the right, under certain
          ...
          than storing it. <br /> <br /> (VI) you have the right, under certain
          circumstances, to obtain the erasure of your Personal Information from
          us. <br /> <br /> (VII) you have the right to receive your information
          ...
          without any hindrance. This provision is applicable provided that your
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Privacy of Children</p>
        <p>
          ...
          <br /> <br /> We encourage parents and legal guardians to monitor
          ...
          through the Website and Services without their permission. <br />{' '}
          <br /> If you have reason to believe that a child under the age of 18
          has provided Personal Information to us through the Website and
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Do Not Track Signals</p>
        <p>
          ...
          tracked. <br /> <br /> Tracking is not the same as using or collecting
          information in connection with a website. For these purposes, tracking
          refers to collecting personally identifiable information from
          consumers who use or visit a website or online service as they move
          across different websites over time. <br /> <br /> How browsers
          communicate the Do Not Track signal is not yet uniform. As a result,
          the Website and Services are not yet set up to interpret or respond to
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Email Marketing</p>
        <p>
          ...
          accordance with applicable laws and regulations. <br /> <br /> In
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Links to Other Resources</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Information Security</p>
        <p>
          ...
          disclosure. <br /> <br /> We maintain reasonable administrative,
          ...
          Information in its control and custody. <br /> <br /> However, no data
          ...
          acknowledge that: <br /> <br /> (I) there are security and privacy
          limitations of the Internet which are beyond our control; <br />{' '}
          <br /> (II) the security, integrity, and privacy of any and all
          information and data exchanged between you and the Website and
          Services cannot be guaranteed. <br /> <br /> (III) any such
          information and data may be viewed or tampered with in transit by a
          third party, despite best efforts.
        </p>
      </div>
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Data Breach</p>
        <p>
          ...
          and cooperation with law enforcement authorities. <br /> <br /> In the
          event of a data breach, we will make reasonable efforts to notify
          ...
          required by law. When we do, we will send you an email, get in touch
          with you over the phone.
        </p>
      </div>
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Changes and Amendments</p>
        <p>
          ...
          Personal Information. <br /> <br /> When we do, we will post a
          ...
          information you have provided. <br /> <br /> Any updated version of
          this Policy will be effective immediately upon the posting of the
          revised Policy unless otherwise specified. Your continued use of the
          Website and Services after the effective date of the revised Policy
          (or such other act specified at that time) will constitute your
          consent to those changes. <br /> <br /> However, we will not, without
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Acceptance of this Policy</p>
        <p>
      ...
      <div className='flex flex-col gap-3'>
        <p className='font-bold text-3xl'>Contacting us</p>
        <p>
          ...
          trading@Luxurylevelco.com <br /> <br />
