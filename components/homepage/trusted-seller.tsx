export default function TrustedSeller() {
  return (
    <div className="section-style relative h-auto bg-[url('/homepage-assets/bg.webp')] bg-cover bg-center bg-no-repeat p-10 md:p-20 bg-black">
      <div className='absolute inset-0 bg-black opacity-70 z-0' />
      <div className='relative z-10 flex flex-col w-full md:w-1/2 h-fit text-center md:text-start'>
        <div>
          <p className='font-semibold text-white text-4xl md:text-7xl'>
            TRUSTED SELLER
          </p>
          ...
          <p className='text-white text-xl pt-5'>
            ...
            world&apos;s most reputable luxury watch platforms is a testament to
            our integrity, authenticity, and client-first approach.
          </p>
          <p className='text-white text-xl pt-5'>
            ...
            inspire confidence. Whether you&apos;re acquiring a rare
            collector&apos;s piece or a timeless icon, we ensure every
            transaction is seamless, transparent, and secure.
          </p>
          <p className='text-white text-xl pt-5'>
