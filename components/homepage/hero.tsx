...
export default function Hero() {
  return (
    <div className="section-style relative bg-[url('/homepage-assets/hero.avif')] bg-no-repeat bg-[center_top_20px] bg-[length:800px_auto] md:bg-[length:auto] p-20 bg-[#000100] ">
