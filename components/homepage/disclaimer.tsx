export default function Disclaimer() {
  return (
    <div className="section-style relative h-auto w-full bg-[url('/homepage-assets/disclaimerbg.webp')] bg-cover bg-center bg-no-repeat py-10 px-10 md:px-40 bg-black">
